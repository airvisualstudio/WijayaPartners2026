...
import logo from "@/assets/logo-wijaya.svg";
...
export function Header() {
  ...
  return (
    <header className="fixed top-4 left-0 right-0 z-50 flex flex-col items-center gap-4 px-4">
      ...
      <nav className="relative container max-w-5xl rounded-full border bg-background/80 backdrop-blur-md shadow-sm h-16 flex items-center justify-between px-6 w-full">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="absolute top-36 left-4 right-4 rounded-2xl border bg-background/95 backdrop-blur-md shadow-xl p-4 md:hidden">
